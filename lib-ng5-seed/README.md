...
[travis-badge]: https://travis-ci.org/filipesilva/angular-zuker-ngscale-ngcomponentlib.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-zuker-ngscale-ngcomponentlib
...
1. Create a project folder (you can call it `zuker-ngscale-ngcomponentlib` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-zuker-ngscale-ngcomponentlib.git
cd angular-zuker-ngscale-ngcomponentlib
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-zuker-ngscale-ngcomponentlib/archive/master.zip)
...
Use your editor to search the project for all instances of `zuker-ngscale-ngcomponentlib` and change it
